...
void D3DApp::OnResize()
{
	...
	XMMATRIX P = XMMatrixPerspectiveFovLH(0.25f * 3.1416, static_cast<float>(mClientWidth) / mClientHeight, 1.0f, 1000.0f);
...
void D3DApp::BuildShadersAndInputLayout()
{
	...
	D3DCompileFromFile(L"Shaders\\color.hlsl", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
...
Microsoft::WRL::ComPtr<ID3D12Resource> D3DApp::CreateDefaultBuffer(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList, const void* initData, UINT64 byteSize, Microsoft::WRL::ComPtr<ID3D12Resource>& uploadBuffer)
{
...
void  D3DApp::OnMouseMove(WPARAM btnState, int x, int y)
{
	if ((btnState & MK_LBUTTON) != 0)
	{
		...
		mPhi = Clamp(mPhi, 0.1f, 3.1416f - 0.1f);
	}
